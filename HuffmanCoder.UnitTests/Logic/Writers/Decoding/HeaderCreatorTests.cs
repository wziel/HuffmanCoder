...
namespace HuffmanCoder.UnitTests.Logic.Writers.Decoding
{
    ...
    public class HeaderCreatorTests
    {
        ...
        public void WithoutMap()
        {
            ...
            Header header = headerCrator.Create(HuffmanEncodeModel.Standard, true, new Dictionary<string, HuffmanCoder.Logic.Entities.OutputValues>());
        ...
        public void OneSymbolInMap()
        {
            ...
            Header header = headerCrator.Create(HuffmanEncodeModel.Standard, true, map);

            // Expected: header size - 4 bytes, huffmanEncodeModel - 1 byte, specialSymbol - 1 byte, map (A5) - 3 bytes
            Assert.AreEqual(9, header.Content.Length);
        }
        ...
        public void ThreeSymbolsInMap()
        {
            ...
            Assert.AreEqual(15, header.Content.Length);
        }
